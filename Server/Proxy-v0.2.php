<?php
/*
* xIdent; entwickelt im Rahmen von JugendHackt
* Julius Herb und Andere
* Hinweis: Diese Version vom Proxy unterstützt Cookies und damit auch PHP-Sessions, die beim Login benötigt werden.
* Allerdings erzielt Version 0.1 auf den meisten Webseiten eine bessere Anzeige.
*/
